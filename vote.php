...
<body ng-controller="VoteController">
	...
	<div style="width:100%;">
		...
		<div style="margin: 16px auto; width:20%; text-align:center;">
			...
			<button type="button" class="btn btn-danger" ng-hide="pollClosed" ng-click="voteA()">Vote Debater A</button>&nbsp;&nbsp;&nbsp;
			<button type="button" class="btn btn-info" ng-hide="pollClosed" ng-click="voteB()">Vote Debater B</button>
