...
if(
    ...
    $poll->start_date = date('Y-m-d H:i:s');
    ...
    if($poll->create()){
        ...
        // tell the user
        echo json_encode(array("message" => "Poll was created.", "id" => $poll->id));
    }
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to create poll. Data is incomplete."));
}
?>